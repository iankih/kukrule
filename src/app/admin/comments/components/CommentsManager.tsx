                    ...
                    <div className="flex justify-between items-start">
                      <div className="flex-1">
                        ...
                        <div className="flex items-center space-x-3 mb-2">
                          <div className="w-8 h-8 bg-[#E8F0EB] rounded-full flex items-center justify-center flex-shrink-0">
                            <svg className="w-5 h-5 text-[#2D5F3F]" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    {comment.products && (
                      <div className="ml-11 mt-2">
                        <button
                          ...
                          className="text-sm text-[#2D5F3F] hover:text-[#1A3323] underline"
                        >
                          제품 보기 →
                        </button>
                      </div>
