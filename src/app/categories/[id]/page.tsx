      ...
      <div className="w-full max-w-[600px] min-w-[320px] bg-white min-h-screen shadow-xl">
          ...
          <div className="px-4 py-3">
            <form onSubmit={handleSearch}>
              <div className="relative">
                ...
                <button 
                  type="submit"
                  className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-[#2D5F3F]"
                >
        ...
        <div className="bg-white px-4">
          <div className="flex items-center space-x-4 border-b border-gray-200 pb-2">
            ...
            <span className="text-sm font-medium text-[#2D5F3F]">{category?.name || '카테고리'}</span>
          </div>
        </div>
