    ...
    <div className="min-h-screen bg-gray-100 flex justify-center">
      ...
      <div className="w-full max-w-[600px] min-w-[320px] bg-white min-h-screen shadow-xl">
        ...
        {showScrollTop && (
          <button
            onClick={scrollToTop}
            className="fixed bottom-6 right-6 w-12 h-12 bg-primary hover:bg-primary-hover text-white rounded-full shadow-lg flex items-center justify-center transition-all duration-300 z-50"
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
